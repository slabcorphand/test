...
public class PicService {
    ...
    public int deleteStudioUsefulMessagePicUrl(UsefulMessageForm form) {
        Pic pic = new Pic();
        pic.setItemId(form.getId());
        pic.setDelFlg(Boolean.TRUE);
        int count = picMapper.deleteStudioUsefulMessagePicUrl(pic);
        System.out.println(count);
        return count;
    }
    ...
    public int deleteUsefulMessagePicUrl(Long usefulMessageId, int type) {
        Pic pic = new Pic();
        pic.setItemId(usefulMessageId);
        pic.setItemType((byte)type);
        pic.setDelFlg(Boolean.TRUE);
        int count = picMapper.deleteStudioUsefulMessagePicUrl(pic);
        return count;
