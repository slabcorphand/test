...
public class WidgetService {
    ...
    public String getUsefulMessageType(int usefulMessageTypeNum) {
        String category = "";
        if (usefulMessageTypeNum == Constant.UsefulMessage_TYPE.UNKNOW) {
            category = "不明";
        } else if (usefulMessageTypeNum == Constant.NEWS_TYPE.MOVEUP) {
            category = "MOVEUP";
        } else if (usefulMessageTypeNum == Constant.NEWS_TYPE.EVENT) {
            category = "EVENT";
        } else if (usefulMessageTypeNum == Constant.NEWS_TYPE.NEWS) {
            category = "NEWS";
        }else if (usefulMessageTypeNum == Constant.NEWS_TYPE.ENTRY) {
            category = "EVENT";
        }
        return category;
    }
    ...
    public String getUsefulMessageColor(int newsTypeNum) {
        String color = "";
        if (newsTypeNum == Constant.NEWS_TYPE.MOVEUP) {
            color = "background-color:red";
        } else if (newsTypeNum == Constant.NEWS_TYPE.EVENT || newsTypeNum == Constant.NEWS_TYPE.ENTRY) {
    ...
    public String getUsefulMessageDetailColor(int newsTypeNum) {
        String color = "";
        if (newsTypeNum == Constant.NEWS_TYPE.MOVEUP) {
            color = "color:red";
        } else if (newsTypeNum == Constant.NEWS_TYPE.EVENT|| newsTypeNum == Constant.NEWS_TYPE.ENTRY) {
